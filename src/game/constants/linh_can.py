...
LINH_CAN_DATA: dict[str, dict] = {
    ...
    "tho": {
        ...
        "scaling": {
            ...
            "thresholds": {
                3: {"add_passive": {
                        "shield_max_flat": 80,
                        "shield_regen_pct": 0.02,
                        "shield_regen_flat": 20,
                    },
                    "label": "Lv3 — Cương Phách: +80 khiên nền, hồi 2% + 20 khiên/lượt"},
                5: {"add_passive": {
                        "shield_max_pct": 0.10,
                        "damage_bonus_from_shield_pct": 0.10,
                        "thorn_pct": 0.06,
                    },
                    "label": "Lv5 — Hậu Thổ Cương Vực: +10% khiên tối đa, +10% ST từ khiên, 6% phản đòn"},
                7: {"add_passive": {
                        "shield_max_pct": 0.15,
                        "shield_regen_flat": 40,
                        "atk_from_shield_pct": 0.06,
                        "matk_from_shield_pct": 0.06,
                    },
                    "label": "Lv7 — Bàn Cổ Hộ Thuẫn: +15% khiên tối đa, +40 hồi khiên/lượt, +6% Công/Pháp theo khiên"},

                9: {"add_passive": {
                        "final_dmg_reduce": 0.10,
                        "damage_bonus_from_shield_pct": 0.20,
                        "shield_max_pct": 0.20,
                        "thorn_from_shield": True,
                        "stun_on_hit_pct": 0.05,
                    },
                    "label": "Lv9 — Bàn Cổ Thổ Cốt: +10% giảm ST, +20% ST từ khiên, +20% khiên tối đa, phản từ khiên, 5% choáng"},
            },
        },
    },
    "phong": {
        ...
        "scaling": {
            ...
            "thresholds": {
                3: {"add_passive": {"evasion_rating": 500},
                    "label": "Lv3 — Lưu Phong: +500 né tránh"},
    ...
    "loi": {
        ...
        "scaling": {
            ...
            "thresholds": {
                ...
                7: {"add_passive": {"element_pen": {"loi": 0.15}, "shock_stack_cap_bonus": 1},
    ...
    "quang": {
        ...
        "scaling": {
            ...
            "proc_chance_per_level": 0.015,
            "thresholds": {
                3: {"add_passive": {"cleanse_on_turn_pct": 0.15},
                    "label": "Lv3 — Tẩy Tâm: +15% Thanh Tẩy"},
                ...
                9: {"add_passive": {"heal_pct": 0.20, "heal_can_crit": True, "element_pen": {"quang": 0.15}},
