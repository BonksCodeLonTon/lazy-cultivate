# cultivation-bot — Wiki

_Generated 2026-04-08 — re-run `npx codesight --wiki` if the codebase has changed._
...
- Models: **7**
- Components: **0**
- Env vars: **2** required, **9** with defaults
...
---
_Last compiled: 2026-04-08 · 3 articles · [codesight](https://github.com/Houseofmvps/codesight)_