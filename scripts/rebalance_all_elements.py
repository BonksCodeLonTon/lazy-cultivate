    ...
    "phong": [
        {
            ...
            "effects": ["DebuffCuonBay", "DebuffAnPhong", "DebuffLamCham"],
            "formation_key": None,
            "description_vi": "Phong toàn cuồng vũ — cuốn bay, phong ấn né tránh, làm chậm địch.",
            "effect_overrides": {
                "DebuffCuonBay":  {"duration": 1},
                "DebuffAnPhong":  {"stat_bonus": {"evasion_rating": -180}, "duration": 4},
        ...
        },
        {
            ...
            "effects": ["DebuffCuonBay", "DebuffAnPhong", "DebuffLamCham", "DebuffBaoMon"],
            "formation_key": None,
            "description_vi": "Phong bão thần thoại — đỉnh Phong R7, cuốn bay liên hoàn, bào mòn kháng tính.",
            "effect_overrides": {
                "DebuffCuonBay":  {"duration": 2},
                "DebuffAnPhong":  {"stat_bonus": {"evasion_rating": -260}, "duration": 4},
        ...
        },
        {
            ...
            "effect_overrides": {
                "DebuffCuonBay":  {"duration": 2},
                "DebuffAnPhong":  {"stat_bonus": {"evasion_rating": -300}, "duration": 4},
